...
public:
	...
	std::shared_ptr<InternalObjectController> getInternalMoveObjectController_OverShoot(const std::shared_ptr<ObjectBase> &obj, const std::shared_ptr<MoveObjectProperty> &prop, double vel_target) override;
};